...
{
    public class SidsCollectorTest: AbstractCollectorTestCase
    {
        [Fact]
        public void TestItReturnsElementsInOrder()
        {
            ...
            SidStarRoute first = SidStarRouteFactory.Make(definition: DefinitionFactory.Make("foo.txt"));
            SidStarRoute second = SidStarRouteFactory.Make(definition: DefinitionFactory.Make("goo.txt"));
            SidStarRoute third = SidStarRouteFactory.Make(definition: DefinitionFactory.Make("foo.txt"));
        ...
        {
            return OutputSectionKeys.SCT_SID;
        }
    }
}
