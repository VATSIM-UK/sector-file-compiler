...
{
    public class AllSectorsMustHaveValidDepartureAirportsTest
    {
        private readonly SectorElementCollection elements;
        private readonly AllSectorsMustHaveValidDepartureAirports validator;
        ...
        public AllSectorsMustHaveValidDepartureAirportsTest()
        {
            ...
            this.validator = new AllSectorsMustHaveValidDepartureAirports();
        ...
        public void TestItPassesOnAllValid(string first, string second, string third)
        {
            this.elements.Add(
                new Sector(
                    ...
                    new SectorArrivalAirports(new List<string>() { "EGLL" }, ""),
                    new SectorDepartureAirports(new List<string>() { first, second }, ""),
                    "comment"
                )
            );
            this.elements.Add(
                new Sector(
                    ...
                    new SectorArrivalAirports(new List<string>() { "EGLL", "EGBB" }, ""),
                    new SectorDepartureAirports(new List<string>() { second, third }, ""),
                    "comment"
                )
            );
