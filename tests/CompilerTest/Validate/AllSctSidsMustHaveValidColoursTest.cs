...
{
    public class AllSctSidsMustHaveValidColoursTest
    {
        private readonly SectorElementCollection sectorElements;
        private readonly Mock<IEventLogger> loggerMock;
        private readonly Colour definedColour;
        private readonly AllSctSidsMustHaveValidColours rule;
        ...
        public AllSctSidsMustHaveValidColoursTest()
        {
            ...
            this.rule = new AllSctSidsMustHaveValidColours();
            this.args = new CompilerArguments();
            this.segments1 = new List<RouteSegment>();
            this.segments2 = new List<RouteSegment>();
            this.sectorElements.Add(this.definedColour);
            this.sectorElements.Add(new SidStarRoute(SidStarType.SID, "Test", this.segments1));
            this.sectorElements.Add(new SidStarRoute(SidStarType.SID, "Test", this.segments2));
        }
