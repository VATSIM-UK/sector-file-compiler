...
namespace CompilerTest.Compile
{
    public class CompileEngineTest
    {
        ...
        public CompileEngineTest()
        {
            ...
            this.elements.Add(new CommentLine("test1"), OutputSections.ESE_SIDSSTARS, Subsections.DEFAULT);
            this.elements.Add(new CommentLine("test2"), OutputSections.ESE_AIRSPACE, Subsections.DEFAULT);
        }
